      ...
      <View style={styles.newsImageContainer}>
        {filteredNews.map((newsItem) => (
          <TouchableOpacity
           ...
           <Image source={{ uri: `http://192.168.255.85:80/apis/${newsItem.image_path}` }} style={styles.newsImage} /><Text style={styles.textt}><Text style={styles.textt1}>{newsItem.context}:</Text> <Text style={styles.textt2}>{newsItem.summary}</Text> </Text>
