...
const TechBadges = () => {
  return (
    <View style={{flexDirection: 'row', flexWrap: 'wrap', marginTop: 10}}>
      ...
      <Image source={{uri: 'https://learnbatta.com/assets/images/javascript/javascript-logo.png'}} style={{width: 210, height: 60, marginRight: 10, marginBottom: 10}} resizeMode="contain" />
